    ...
    <section id="one" class="wrapper style1 special">
        <div class="inner">
            <header class="major">
                ...
                <a href="#" onclick="play()" style="float: right;margin-top: -32px;border-bottom: dotted 0px; */">播放视频</a>
								<span>会员视频播放采用第三方接口进行解析播放，播放中弹出的广告均与本站无关<br />
								如若视频不能正常播放，请尝试重新点击播放视频按钮进行播放</span>
            </header>
