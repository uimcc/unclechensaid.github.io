        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="audio-toggle"><a href="https://uimcc.com/"><i class="fa fa-volume-up"></i>UIMCC</a></li>
                </ul>
            </div> <!-- .navbar-collapse -->
        </div>
    </nav>
...
<div id="contact" class="section block-default">
    <div class="container">
        <div class="section-heading text-center">
            <h2>联系我们</h2>
            <p>任何使用问题，团队建设问题，运营商如何加入问题，可以咨询我们客服微信:belvme</p>
        </div>
